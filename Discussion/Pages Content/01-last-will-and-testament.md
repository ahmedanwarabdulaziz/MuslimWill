# Page: Last Will & Testament

**URL:** `/last-will`
**Nav location:** Individuals & Families › My Bridge
**Eyebrow on page:** My Bridge › Last Will & Testament

---

## Page Role

The user arrives here already knowing what Islamic inheritance is.
They want to know two things:

1. Does this platform handle Faraid correctly?
2. Will my will actually hold up under Canadian law?

The page educates on what's covered, builds trust on both the Islamic and legal sides, then converts to application.

---

## Audience

A Muslim in Canada — most likely in Ontario — who understands Faraid and Islamic inheritance, has been meaning to prepare a proper will, and wants assurance that this service gets it right on both levels.
...
## Trust Anchors (below H1 — short bar)
...
**H2:** What goes into your Islamic will
...
## Section 3 — The Vault: What Makes This Will Different

**H2:** Your will is not a document you file and forget.
...
**Secured and released at the right moment**
...
## Section 5 — How It Works (brief, link to full page)

**H2:** From your details to a signed document

**Short 4-step summary:**

1. **Complete the guided application** — family details, assets, heirs, guardianship, and charitable intentions
2. **Faraid is calculated** — the platform structures your inheritance shares based on Islamic law
3. **Your document is prepared** — structured to meet Ontario legal requirements
4. **Review, sign, and witness** — your will is complete when correctly executed

**Link:** See the full process → [How It Works](/how-it-works)

---

## Section 6 — Complete Your Estate Plan (Cross-sell)

**H2:** A will is the foundation. Powers of Attorney protect you while you are still here.
...
**Note:** Both POAs are included in the Full Package ($350) alongside your will, Scholar Review, Admin Review, and Digital Attestation — a combined value of $594.

---

## Section 7 — Final CTA

**H2:** Your will is one of the most important things you will ever prepare.
...
- → How It Works
- → Charitable Legacy (for users interested in the bequest section)
- → Pricing
- → Our Scholars (for users asking about Islamic review)
- → Compliance (for users asking about legal validity)
- → Start My Application (CTA)

---

## SEO Notes

**Primary keyword:** `Islamic will Ontario`
**Secondary:** `Islamic will Canada`, `Shariah compliant will Ontario`, `Muslim will Ontario legal`

**Title tag:** `Islamic Will Ontario | Faraid-Based, Ontario Legal | The Muslim Will`
**Meta description:** `Prepare an Islamic will in Ontario that reflects Faraid inheritance principles and meets Canadian legal requirements — through a guided application built for Muslim families.`

---

## Tone Checklist

- ✓ Speaks peer-to-peer — assumes the user knows what Faraid means
- ✓ Does not explain Islam to Muslims
- ✓ Clear on what is and is not included
- ✓ Legal boundary stated without apology
- ✓ Add-ons framed as situational, not as completing the will
- ✓ Calm, premium, direct
