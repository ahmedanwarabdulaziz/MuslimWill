# Page: Charitable Legacy

**URL:** `/charitable-legacy`
**Nav location:** Individuals & Families › My Bridge
**Eyebrow on page:** My Bridge › Charitable Legacy

---

## Page Role

This page speaks to the Muslim who wants their wealth to keep doing good after they are gone — without taking from what their family is owed. It answers the most common hesitation: *"Can I give to charity and still protect my family?"*

The answer is yes. Islamic law already solved this problem. This page explains how, builds trust that it is handled correctly on the platform, and converts toward starting the application.

It also bridges naturally to the Community & Giving section — for users who arrive here through a charity partner or mosque programme.

---

## Audience

A Muslim in Canada who cares deeply about charitable giving and wants to make it a permanent part of their legacy — but is unsure whether it conflicts with their family's inheritance rights. They may be connected to a charity or masjid. They understand Islamic giving but may not know the formal rules around bequests.
...
- ✓ Stored securely in your Vault — your intention protected for the right moment

---

## Section 1 — How Charitable Legacy Works in Islamic Law

**H2:** Islam already made room for your generosity
...
**H2:** A good intention without a document is just a hope.
...
## Section 3 — The Vault: Your Giving, Protected and Explained

**H2:** Your will documents the gift. Your Vault carries the meaning behind it.
...
**Your Charitable Designation, Secured**
...
**Soft bridge to Community & Giving:**
> Are you a charity or mosque looking to help your community plan their estates and bequests? See our partnership programmes. `→ Community & Giving`
...
**H2:** Your charitable legacy is part of your will — make sure the whole picture is in place.
...
**Last Will & Testament — included in The Bridge**
...
**H2:** Your generosity deserves to outlast you.
...
- → Last Will & Testament
- → My Vault
- → Community & Giving (for charity/masjid partners)
- → Our Scholars (for Waqf or complex bequest questions)
- → How It Works
- → Pricing
...
**Primary keyword:** `charitable bequest Islamic will Canada`
...
- ✓ Opens with reassurance — family is protected, giving is permitted
- ✓ Islamic language is precise — 1/3 rule, Faraid, Sadaqah Jariyah, Waqf
- ✓ Emotional depth in the Vault section — message for charity, message for family
- ✓ No restriction on which charity — user's choice
- ✓ Bridges naturally to Community & Giving without pushing
- ✓ Final CTA uses the established brand phrase about trust and mercy
- ✓ Ontario-first, Canada-aware
- ✓ Calm, premium, spiritually grounded
