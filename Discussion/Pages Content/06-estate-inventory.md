...
**URL:** `/vault/estate-inventory`
**Nav location:** Individuals & Families › My Vault
**Eyebrow on page:** My Vault › Estate Inventory

---

## Page Role

This page addresses a painful and common reality — assets that go undiscovered after death because no one documented where they were. Bank accounts left dormant. Insurance policies never claimed. Safety deposit boxes no one knew existed. Investments that simply disappear.

The page makes the user feel the practical weight of this, adds the Islamic dimension of justice toward heirs, then shows how the Estate Inventory gives their executor a complete picture — everything in one place, released at the right moment.

---

## Audience

A Muslim with financial accounts, property, insurance, investments, or any assets that their family might struggle to locate after their passing. They may not think of themselves as wealthy — but they have more than they realise that needs to be found and properly distributed.
...
**H2:** Most estates lose assets before they are ever distributed
...
**H2:** Everything your executor needs to find what is yours
...
**H2:** Complete, private, and ready when it is needed

**Three process points:**

**You build it privately**
...
## Section 4 — The Other Side: What You Owe

**H2:** A complete picture includes both sides
...
**Obligations Register — included in The Bridge**
...
**H2:** Everything you have built deserves to reach the people it was meant for.
...
**Primary keyword:** `Islamic estate inventory Canada`
**Secondary:** `Muslim estate assets Ontario`, `executor estate checklist Canada`, `Islamic inheritance assets documentation`

**Title tag:** `Estate Inventory | Document Your Assets for Your Executor | The Muslim Will`
**Meta description:** `Store a complete record of your accounts, property, investments, and assets in your private Vault — so your executor can find everything your family is owed.`

---

## Tone Checklist

- ✓ Opens with a practical, undeniable truth — assets go missing
- ✓ Islamic angle is justice-focused — heirs have a right to everything
- ✓ Covers digital assets — often missed by other platforms
- ✓ Privacy of the Vault is central — family cannot see it while you are alive
- ✓ Cross-sell to Obligations Register is logical and natural
- ✓ No add-ons section — this is a Vault feature
- ✓ Calm, practical, dignified
