# Page: Power of Attorney for Property

**URL:** `/poa-property`
**Nav location:** Individuals & Families › My Bridge
**Eyebrow on page:** My Bridge › Power of Attorney for Property

---

## Page Role

This page addresses the financial side of incapacity. The user is alive but unable to manage their money, property, or financial affairs. Without a POA for Property, their family may be locked out of accounts, unable to pay bills, or forced into a court-supervised arrangement to access funds.

The page must make the financial risk of not having this document feel immediate and real — then show how The Muslim Will makes the process clear, legally valid, and supported by the Vault.

---

## Audience

A Muslim in Canada — likely with assets, a mortgage, accounts, or a business — who has not formally appointed someone to manage their finances if they become incapacitated. They may assume their spouse has automatic access to everything. In most cases, they do not.
...
- ✓ Legally valid under Ontario law
- ✓ Covers accounts, property, investments, and financial decisions
- ✓ Appoint the person you trust to manage your wealth
- ✓ Paired with your private Vault for financial instructions and asset details

---

## Section 1 — What a POA for Property Covers

**H2:** Financial authority when your family needs it most
...
**H2:** Wealth in Islam is an Amanah — a trust. Protect it with the right person.
...
## Section 3 — The Vault: Your Financial Instructions, Secured

**H2:** Your POA gives them authority. Your Vault tells them where everything is.
...
**CTA:** `See What's in the Vault →`

---

## Section 4 — Legal Compliance

**H2:** Legally valid under Ontario law
...
**Legal boundary note:**
> Muslim Will is not a law firm. For complex situations — significant business interests, multiple properties, cross-border assets, or contested family arrangements — additional legal counsel may be appropriate.

---

## Section 5 — Optional Expert Services

**H2:** When your situation calls for more
...
**H2:** Property is one half. Personal care decisions need protection too.
...
**Full Package note:**
> Both Powers of Attorney are included in the Full Package ($350) alongside your Islamic Will, Scholar Review, Admin Review, and Digital Attestation — a combined value of $594.

---

## Section 7 — Final CTA

**H2:** The people who depend on you deserve more than uncertainty.
...
- → My Vault (Vault page)
- → Estate Inventory (Vault branch)
- → Obligations Register (Vault branch)
- → How It Works
- → Pricing
- → Compliance
...
**Primary keyword:** `Power of Attorney property Ontario Muslim`
**Secondary:** `Islamic POA property Canada`, `Muslim power of attorney finances Ontario`, `property POA Ontario`

**Title tag:** `Power of Attorney for Property | Ontario | The Muslim Will`
**Meta description:** `Give a trusted person legal authority to manage your finances and property — a legally valid Power of Attorney for Property built for Muslim families in Ontario.`

---

## Tone Checklist

- ✓ Financial urgency is real but not alarmist
- ✓ Islamic angle (Amanah) is specific and grounded
- ✓ Vault connection is practical — Estate Inventory and Obligations Register tie in naturally
- ✓ Legal boundary stated clearly
- ✓ Cross-sell to POA Personal Care feels like a natural completion
- ✓ Ontario-first, Canada-aware
- ✓ Calm, premium, direct
