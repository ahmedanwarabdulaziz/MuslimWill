# Page: Power of Attorney for Personal Care

**URL:** `/poa-personal-care`
**Nav location:** Individuals & Families › My Bridge
**Eyebrow on page:** My Bridge › Power of Attorney for Personal Care

---

## Page Role

This page speaks to a different fear than the will — not death, but incapacity. The user is alive but cannot communicate. Who makes decisions for them?

The page must make the user feel the urgency of appointing someone trusted now — before the moment arrives — then show how The Muslim Will makes that process clear, legally valid, and privately supported through the Vault.

---

## Audience

A Muslim in Canada — likely with a family — who understands the concept of a POA but has not yet formalised one. They may assume their spouse will automatically have authority, or they may not have thought about it at all. The page should gently correct that assumption and move them to act.
...
- ✓ Appoint the person you trust most
- ✓ Covers healthcare, personal care, and living decisions
- ✓ Paired with your private Vault for incapacity instructions

---

## Section 1 — What a POA for Personal Care Covers

**H2:** The decisions no one should have to guess at
...
**H2:** Your faith shapes how you want to be treated. Document it.
...
## Section 3 — The Vault: Your Private Instructions for Your POA Holder

**H2:** A POA names who decides. Your Vault tells them what you want.
...
**Private Incapacity Instructions**
...
**Sensitive Guidance You Cannot Say Out Loud**
...
**Legal boundary note:**
> Muslim Will is not a law firm. For complex personal care situations — significant medical conditions, contested family arrangements, or cross-provincial considerations — additional legal counsel may be appropriate.
...
**Two cards (Scholar Review less relevant here — Admin and Attestation are primary):**
...
**H2:** Personal care is one half. Your property needs protection too.
...
**H2:** The people who love you should not have to guess what you want.
...
**Primary keyword:** `Power of Attorney personal care Ontario Muslim`
**Secondary:** `Islamic POA Canada`, `Muslim power of attorney Ontario`, `personal care POA Ontario`

**Title tag:** `Power of Attorney for Personal Care | Ontario | The Muslim Will`
**Meta description:** `Designate a trusted person to make healthcare and personal decisions on your behalf — a legally valid Power of Attorney for Personal Care built for Muslim families in Ontario.`

---

## Tone Checklist

- ✓ Urgency without fear-mongering — the user should feel motivated, not anxious
- ✓ Islamic angle is specific and respectful — not generic
- ✓ Vault connection feels natural, not forced
- ✓ Legal boundary stated clearly
- ✓ Cross-sell to POA Property feels like a completion, not a push
