...
**URL:** `/about/faq`
**Nav location:** About › Trust & Transparency
**Eyebrow on page:** Trust & Transparency › FAQ

---

## Page Role

The FAQ page answers the real questions families, professionals, and organisations ask before they act. It should feel like a calm, knowledgeable conversation — not a legal disclaimer. Every answer is direct, complete, and honest. This page also serves AEO — it is structured to be picked up by AI search tools as a direct answer source.
...
### About The Muslim Will Platform
...
**Note:** *Can't find your answer here? Our team responds to every question personally.*
...
**Title tag:** `FAQ | Islamic Will Canada | The Muslim Will`
**Meta description:** `Clear answers to the most common questions about Islamic wills in Canada — Faraid, legal validity, pricing, the Vault, and how The Muslim Will works.`

**Schema:** FAQPage (structured data — every Q&A pair should be marked up)
