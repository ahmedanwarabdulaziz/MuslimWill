    ...
    <header className={`${styles.header} ${isScrolled ? styles.scrolled : ''}`}>
      <div className={styles.container}>
        ...
        <Link href="/" className={styles.logoArea}>
          <img src="/Images/logooo.png" alt="Muslim Will Logo" className={styles.logoImage} />
        </Link>
        ...
        <nav className={styles.desktopNav}>
          ...
          <Link href="/for-charities" className={styles.navLink}>For Charities</Link>
      ...
      {mobileMenuOpen && (
        <div className={styles.mobileDrawer}>
          <nav className={styles.mobileDrawerNav}>
            ...
            <Link href="/for-charities" className={styles.mobileLink} onClick={() => setMobileMenuOpen(false)}>For Charities</Link>
