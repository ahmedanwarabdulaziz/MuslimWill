        ...
        <div className={`${sharedStyles.container} ${sharedStyles.heroContent}`}>
          <div className={sharedStyles.heroTextWrapper}>
             ...
             <div className={`${sharedStyles.heroActions} ${sharedStyles.fadeUp} ${sharedStyles.delay3}`} style={{ marginBottom: '1.5rem' }}>
               <TrackedButton href="https://app.themuslimwill.com/Account/Register" variant="secondary" size="lg" eventName="start_will_hero_click" eventParams={{ location: 'about' }}>Start Your Will</TrackedButton>
          ...
          <div className={styles.teamGrid}>
            ...
            <div className={styles.teamCard}>
              <div className={styles.teamImageWrapper}>
                <Image src="/Images/05.jpeg" alt="Ahmed Gohar" fill className={styles.teamImage} />
              </div>
            ...
            <div className={styles.teamCard}>
              <div className={styles.teamImageWrapper}>
                <Image src="/Images/04.jpeg" alt="Dr. Yasser Aboutaha" fill className={styles.teamImage} />
              </div>
              <div className={styles.teamHeader}>
        ...
        <div className={sharedStyles.container}>
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div className={sharedStyles.ctaButtonGroup} style={{ justifyContent: 'center' }}>
              <TrackedButton href="https://app.themuslimwill.com/Account/Register" variant="secondary" size="lg" eventName="start_will_footer_click" eventParams={{ location: 'about' }}>Start Your Will</TrackedButton>
