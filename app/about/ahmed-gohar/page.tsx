...
export default function AhmedGoharPage() {
  return (
    <main style={{ backgroundColor: '#f5f8f6' }}>
      ...
      <section className={styles.hero} aria-label="Ahmed Gohar">
        {/* Note: We use a standard img here to preserve the exact object-position logic from the CSS */}
        <img className={styles.heroPhoto} src="/Images/11.jpeg" alt="Ahmed Gohar" />
        
        <div className={styles.heroInner}>
          <div className={`${styles.eyebrow} ${sharedStyles.fadeUp}`}>Founder & CEO | Patriva / Muslim Will</div>
          <h1 className={`${styles.heroTitle} ${sharedStyles.fadeUp} ${sharedStyles.delay1}`} style={{ color: '#ffffff' }}>Ahmed Gohar</h1>
        ...
        <div className={sharedStyles.container}>
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            <h2 style={{ fontSize: '3rem', fontFamily: 'var(--font-heading)', color: 'var(--color-gold)', marginBottom: '1.5rem', lineHeight: '1.1', fontWeight: 700 }}>
              Build your will on a process designed for clarity.
            </h2>
