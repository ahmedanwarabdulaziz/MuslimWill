  ...
  return (
    <main style={{ backgroundColor: '#f5f8f6' }}>
      ...
      <section className={styles.hero} aria-label="Dr. Yasser Aboutaha">
        ...
        <img className={styles.heroPhoto} src="/Images/10.jpeg" alt="Dr. Yasser Aboutaha" />
        <div className={styles.heroInner}>
          <div className={`${styles.eyebrow} ${sharedStyles.fadeUp}`}>Executive Adviser | Muslim Will</div>
          <h1 className={`${styles.heroTitle} ${sharedStyles.fadeUp} ${sharedStyles.delay1}`} style={{ color: '#ffffff' }}>Dr. Yasser Aboutaha</h1>
          ...
          <div className={`${styles.heroActions} ${sharedStyles.fadeUp} ${sharedStyles.delay3}`}>
             <TrackedButton href="https://app.themuslimwill.com/Account/Login" variant="secondary" size="lg" eventName="start_will_hero_click" eventParams={{ location: 'yasser_landing' }} style={{ backgroundColor: 'var(--color-gold)', color: 'var(--color-green)' }}>
               Start Your Will
             </TrackedButton>
