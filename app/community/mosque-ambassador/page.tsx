      ...
      <div className={styles.trustBar}>
        <div className={styles.trustAnchors}>
          <div className={styles.trustAnchor}>
            ...
            Co-branded with your masjid — your name, your community
          </div>
          <div className={styles.trustAnchor}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            Scholars and legal professionals handle everything
          </div>
          <div className={styles.trustAnchor}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            No liability or complexity for your team
          </div>
          <div className={styles.trustAnchor}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            Khutbah guides, awareness resources, and outreach materials included
          </div>
        </div>
      </div>
