...
function processFile(file) {
  ...
  content = content.replace(/<(TrackedButton|Button)(?![^>]*?href=)([^>]*?)>([^<]*?)Start Your Will([^<]*?)<\/\1>/g, '<$1 href="https://app.themuslimwill.com/Account/Login"$2>$3Start Your Will$4</$1>');
  ...
  content = content.replace(/<(TrackedButton|Button)([^>]*?)href=["'][^"']*?["']([^>]*?)>([^<]*?)Start Your Will([^<]*?)<\/\1>/g, '<$1$2href="https://app.themuslimwill.com/Account/Login"$3>$4Start Your Will$5</$1>');
